  ...
  return (
    <div className="w-full bg-[url('/assets/newsletter-background.jpg')] bg-cover bg-no-repeat bg-center">
      <div className="w-full flex justify-center bg-[#19191980]">
        <div className="w-full max-w-8xl flex flex-col xl:flex-row items-start md:text-center md:items-center xl:text-left xl:justify-between px-5 sm:px-20 py-9 sm:py-7 ">
